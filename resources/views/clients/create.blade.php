                            ...
                            <div class="row">
                                <div class="form-group form-group-sm col-md-12 col-lg-6">
                                    ...
                                    <select name="status" id="status"
                                            class="form-control form-control-sm">
                                        <option value="0" selected disabled> -- Client
                                            status --
                                        </option>
                                        <option
                                        ...
                                        <option
                                            value="8" {{ old('status') == 8 ? 'selected' : '' }}>
                                            No Answer
                                        </option>
                                        <option
                                            value="12" {{ old('status') == 12 ? 'selected' : '' }}>
                                            In progress
                                        </option>
                                        <option
                                            value="3" {{ old('status') == 3 ? 'selected' : '' }}>
                                            Potential
                                            appointment
                                        </option>
                                        <option
                                            value="4" {{ old('status') == 4 ? 'selected' : '' }}>
                                            Appointment
                                            set
                                        </option>
                                        <option
                                            value="10" {{ old('status') == 10 ? 'selected' : '' }}>
                                            Appointment
                                            follow up
                                        </option>
                                        <option
                                            value="5" {{ old('status') == 5 ? 'selected' : '' }}>
                                            Sold
                                        </option>
                                        <option
                                            value="13" {{ old('status') == 13 ? 'selected' : '' }}>
                                            Unreachable
                                        </option>
                                        <option
                                            value="7" {{ old('status') == 7 ? 'selected' : '' }}>
                                            Not interested
                                        </option>
                                        <option
                                            value="11" {{ old('status') == 11 ? 'selected' : '' }}>
                                            Low budget
                                        </option>
                                        <option
                                            value="9" {{ old('status') == 9 ? 'selected' : '' }}>
                                            Wrong Number
                                        </option>
                                        <option
                                            value="14" {{ old('status') == 14 ? 'selected' : '' }}>
                                            Unqualified
                                        </option>
                                    </select>
                                </div>
