...
<head>
    ...
    <meta name="keywords"
          content="admin template, Xolo admin template, dashboard template, flat admin template, responsive admin template, web app (Laravel 8)">
    <meta name="author" content="pixelstrap">
    <link rel="icon" href="<?php echo e(asset('assets/images/favicon.png')); ?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/favicon.png')); ?>" type="image/x-icon">
    <title>Hashim property <?php echo $__env->yieldContent('title'); ?></title>
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo e(route('/')); ?>"><i class="f-16 fa fa-home"></i></a>
                                </li>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="bookmark pull-right">
                                <ul>
                                    ...
                                    <li><a href="#" data-container="body" data-toggle="popover" data-placement="top"
                                           title="" data-original-title="Learning"><i data-feather="layers"></i></a>
                                    </li>
                                    <li>
...
<?php /**PATH C:\wamp64\www\hp\resources\views/layouts/light/master.blade.php ENDPATH**/ ?>